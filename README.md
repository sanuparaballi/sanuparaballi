...
```text
research.focus = {
    "bilevel_optimization":      "surrogate-assisted co-evolutionary search on NP-hard problems",
    "explainable_rl":            "distilling deep RL policies into human-readable rule sets",
    "graph_ml":                  "information cascades, network diffusion, node embeddings",
    "production_experience":     "8+ yrs, APIs serving 10M+ weekly requests"
}
```
...
![Bilevel Optimization](https://img.shields.io/badge/Bilevel_Optimization-1e3a5f?style=flat-square)
![Evolutionary Algorithms](https://img.shields.io/badge/Evolutionary_Algorithms-1e3a5f?style=flat-square)
![Reinforcement Learning](https://img.shields.io/badge/Reinforcement_Learning-1e3a5f?style=flat-square)
![Explainable AI](https://img.shields.io/badge/Explainable_AI_(XAI)-1e3a5f?style=flat-square)
![Graph Neural Networks](https://img.shields.io/badge/Graph_Neural_Networks-1e3a5f?style=flat-square)
![Surrogate Modeling](https://img.shields.io/badge/Surrogate_Modeling-1e3a5f?style=flat-square)
![Information Cascades](https://img.shields.io/badge/Information_Cascades-1e3a5f?style=flat-square)
![Network Science](https://img.shields.io/badge/Network_Science-1e3a5f?style=flat-square)
...
|---|---|---|
| NP-hard bilevel / combinatorial optimization | Surrogate-assisted co-evolutionary ES (decoupled search + evaluation) | **~96% compute reduction**, validated on Max-Cut |
| Distilling deep RL policies into interpretable rules | Hierarchical TSK Fuzzy Classifier System | **81.48% action-matching fidelity** (+21 pts over decision trees); 4-rule variant hit **97.8%** |
| Cascade popularity prediction on social networks | DFS-biased node2vec embeddings | Outperforms state-of-the-art **CasFlow** baseline |
| Enterprise API platform (S&P 500 client) | Architected + led delivery team | Sustained **~10M weekly requests** across ~35 sub-vendor platforms |
...
![Python](https://skillicons.dev/icons?i=python,julia,cpp,pytorch,tensorflow,sklearn,aws,gcp,git,latex&theme=dark)

**ML / DL:** PyTorch · TensorFlow · Scikit-learn · Keras · NetworkX · Gymnasium
**Research:** Bilevel Optimization · Evolutionary Algorithms · RL · XAI · GNNs
**Infra:** AWS · Google Cloud · MLflow · TensorBoard · CUDA/GPU Programming
**Tools:** SQL · Git/GitHub · LaTeX
...
<img src="https://github-profile-trophy.vercel.app/?username=sanuparaballi&theme=tokyonight&no-frame=true&row=1&column=6" />
